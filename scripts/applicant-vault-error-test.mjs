...
for (const input of [new Error(privateValue), new Error(`Invalid ${privateValue}`), {code:'MEMORY_CONFLICT',message:privateValue,factId:privateValue,version:privateValue}, new Error(`sensitive-memory opt-in ${privateValue}`),new Error(`certain answer ${privateValue}`)]) {
