...
console.log('CI workflow policy verified Node 24, locked installs, immutable actions, bounded jobs, minimal permissions, and non-persisted checkout credentials.');
