...
assert.match(conciergeHtml, /Add your resume\. Choose your jobs\. We handle the search\./);
...
assert.match(readinessApi, /readJobAgentWorkerExecutionHealth/);
assert.match(readinessApi, /background-worker-execution/);
