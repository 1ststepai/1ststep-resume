...
assert.match(conciergeHtml, /Let’s get your job search ready\./);
assert.match(conciergeHtml, /Add your resume once\./);
assert.match(conciergeHtml, /Nothing is sent without your approval\./);
...
assert.doesNotMatch(conciergeHtml, /Compare live paths/);
assert.match(conciergeHtml, /What kind of work do you want\?/);
assert.match(conciergeHtml, /Choose one\. You can change this later\./);
...
assert.match(conciergeHtml, /<h2 id="resumeSetupTitle">Add your resume<\/h2>/);
assert.doesNotMatch(conciergeHtml, /Upload yours or build it here/);
...
assert.match(conciergeHtml, /href="\/app\/resume">Edit in Resume Workspace/);
...
assert.match(conciergeJs, /['"]\/api\/concierge-discovery['"]/);
