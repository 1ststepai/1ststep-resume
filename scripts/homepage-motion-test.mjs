...
assert.match(html, /Live phone interview/);
assert.match(html, /This is how much time I actually saved on the task that got me a live phone interview with LogicSource\./);
...
assert.match(css, /@keyframes time-proof-marker/);
