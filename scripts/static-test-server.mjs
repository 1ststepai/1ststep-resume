...
createServer(async (request, response) => {
  try {
    ...
    const relative = pathname === '/concierge' || pathname === '/concierge/' ? 'concierge.html' : pathname === '/app' || pathname === '/app/' || pathname === '/app/resume' ? 'concierge.html' : pathname === '/' ? 'index.html' : pathname.replace(/^\/+/, '');
