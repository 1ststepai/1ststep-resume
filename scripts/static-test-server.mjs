...
createServer(async (request, response) => {
  try {
    ...
    const relative = pathname === '/concierge' || pathname === '/concierge/' ? 'concierge.html' : pathname === '/app' || pathname === '/app/' ? 'concierge.html' : pathname === '/app/resume' ? 'app.html' : pathname === '/partner' || pathname === '/partner/' ? 'partner.html' : pathname === '/' ? 'index.html' : pathname.replace(/^\/+/, '');
