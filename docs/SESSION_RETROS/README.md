...
```txt
Read CLAUDE.md, docs/AI_MEMORY.md, and this retro only. Continue from here: ...
```
```

Do not dump full logs or entire files here. The goal is compressed project memory.
