...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (message === 'PACKAGE_HISTORY_RECONCILIATION_REQUIRED') return res.status(409).json({ error: 'We need to check this job’s application history before preparing another draft.', code: 'PACKAGE_HISTORY_RECONCILIATION_REQUIRED' });
