...
export default async function handler(req, res) {
  ...
  const referralCode = cleanReferralCode(referral.referralCode || referral.ref || '');
          ...
          html: `
            <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
              ...
              <table style="width:100%;border-collapse:collapse">
                ...
                <tr><td style="padding:8px 0;color:#64748B;font-size:14px">Referral</td><td style="padding:8px 0;font-size:14px;color:#0F172A">${escHtml(referralCode || 'Direct / unknown')}</td></tr>
