...
export async function jobAgentConsentGate(config, subject, env = process.env) {
  ...
  const policyConfigurationFailure = ['JOB_AGENT_POLICY_NOT_CONFIGURED', 'JOB_AGENT_OWNER_REVIEWED_POLICY_NOT_CONFIGURED', 'JOB_AGENT_PILOT_NOT_CONFIGURED'].includes(result.code);
