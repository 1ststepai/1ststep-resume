const DEFINITIONS = Object.freeze({
  ...
  CONSENT_ENFORCEMENT_NOT_CONFIGURED: ['legal', 'configuration', 'Require Job Agent consent enforcement. Do not fail open outside an explicit non-production bypass.'],
  OWNER_REVIEWED_POLICY_NOT_CONFIGURED: ['product-owner', 'reviewed-approval', 'Bind JOB_AGENT_OWNER_REVIEWED_POLICY to the exact owner-reviewed Terms, Privacy, authorization, and disclosure versions and digests. This is not counsel approval.'],
  OWNER_REVIEWED_POLICY_NOT_ALLOWED_IN_PRODUCTION: ['product-owner', 'configuration', 'Owner-reviewed controlled beta is Preview-only. Production continues to require the signed-beta release contract and cannot use owner acknowledgment as a substitute.'],
