...
export const AI_ROUTING_PRICE_USD_PER_MILLION = Object.freeze({
  ...
  'gpt-5-nano': Object.freeze({ input: 0.05, output: 0.4, basis: 'standard' }),
  'gpt-5.6-luna': Object.freeze({ input: 0.2, output: 1.2, basis: 'standard' }),
  'gpt-5.6-terra': Object.freeze({ input: 2, output: 12, basis: 'standard' }),
  'deepseek-v4-flash': Object.freeze({ input: 0.14, output: 0.28, basis: 'cache-miss' }),
  'deepseek-v4-pro': Object.freeze({ input: 0.435, output: 0.87, basis: 'cache-miss' }),
});
