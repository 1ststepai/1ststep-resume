...
export const PRODUCTION_ENVIRONMENT_CONTROLS = Object.freeze([
  ...
  Object.freeze({ id: 'owner-reviewed-controlled-beta', stage: 'owner-reviewed-controlled-beta', requirements: Object.freeze([
    requirement('consent-enforcement', 'JOB_AGENT_CONSENT_ENFORCEMENT', 'enabled'),
    requirement('owner-reviewed-policy', 'JOB_AGENT_OWNER_REVIEWED_POLICY', 'enabled'),
    requirement('owner-reviewed-policy-version', 'JOB_AGENT_OWNER_REVIEWED_POLICY_VERSION', 'version'),
    requirement('terms-version', 'JOB_AGENT_TERMS_VERSION', 'version'),
    requirement('privacy-version', 'JOB_AGENT_PRIVACY_VERSION', 'version'),
    requirement('authorization-version', 'JOB_AGENT_AUTHORIZATION_VERSION', 'version'),
  ...
  Object.freeze({ id: 'operator-alerting', requirements: Object.freeze([
    requirement('alerting-approved', 'JOB_AGENT_ALERTING_APPROVED', 'enabled'),
    ...
    requirement('alert-retention', 'JOB_AGENT_ALERT_RETENTION_DAYS', 'retention-days'),
    requirement('alert-acknowledgement-window', 'JOB_AGENT_ALERT_ACKNOWLEDGEMENT_MINUTES', 'acknowledgement-minutes'),
  ]) }),
...
function stateFor(value, kind, env, now) {
  ...
  if (kind === 'acknowledgement-minutes') return Number.isSafeInteger(integer) && integer >= 1 && integer <= 1_440 ? 'valid' : 'invalid';
