...
const SECRET_KEY = /^(password|passcode|otp|captcha|mfa|apiKey|authToken|securityCode|credential)$/i;
const SECRET_VALUE = /\b(?:password|passcode|otp|captcha|mfa|api[_ -]?key|auth[_ -]?token|security code)\s*[:=]\s*\S+/i;
