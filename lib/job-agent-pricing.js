// Single source of truth for the unified 1stStep Complete membership.
//
...
// is off: there is no new checkout, no Stripe price, and no code path that creates a
...
export const UNIFIED_PAID_PLAN = Object.freeze({
  schemaVersion: 2,
  planName: '1stStep Complete',
  entitlementTier: 'complete',
  currency: 'USD',
  monthlyCents: 3900,
  displayMonthly: '$39',
  cadence: 'month',
  ...
  availability: 'early-access-invite-paced',
  includedProducts: Object.freeze([
    'resume-builder',
    'cover-letters',
    'application-tracker',
    'resume-vault',
...
// Backward-compatible export for existing Job Agent readiness and pricing callers.
export const JOB_AGENT_PRICE = UNIFIED_PAID_PLAN;
...
export function publicJobAgentPricing() {
  return {
    ...
    planName: JOB_AGENT_PRICE.planName,
    entitlementTier: JOB_AGENT_PRICE.entitlementTier,
    ...
    includedProducts: [...JOB_AGENT_PRICE.includedProducts],
  };
}
