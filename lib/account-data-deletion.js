...
export async function deleteTenantJobAgentOperationalData({ config, subject, operations = {} }) {
  ...
  const [runs, sessions, browserTasks, submissionTasks, receiptTasks, vault, learning, capturedJobs, campaign, consent, schedule, notifications] = await Promise.all([
  ...
  return {
    ...
    vault, learning, capturedJobs, campaign, consent, schedule, notifications, residualKeys,
  };
}
