...
export async function deleteTenantJobAgentOperationalData({ config, subject, operations = {} }) {
  ...
  const [runs, sessions, browserTasks, submissionTasks, receiptTasks, vault, campaign, consent, schedule, notifications] = await Promise.all([
  ...
  return {
    ...
    vault, campaign, consent, schedule, notifications, residualKeys,
  };
}
