...
function residualIdempotencyPatterns(tenantId) {
  return [
    ...
    `1ststep:job-agent-learning:v1:tenant:${tenantId}:idem:*`,
...
export function buildAccountDataExport({ subject, consent, schedule, notifications, emailSuppression = null, vault, learning = null, partnerAccount = null, campaign, capturedJobs = [], runs = [], applicationSessions = [], employerBrowserTasks = [], applicationSubmissionTasks = [], applicationReceiptTasks = [], employerBrowserSessions = [], collectionCompleteness = null, now = new Date() }) {
  return {
    schemaVersion: 1,
