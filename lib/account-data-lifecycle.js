...
export function buildAccountDataExport({ subject, consent, schedule, notifications, emailSuppression = null, vault, learning = null, campaign, capturedJobs = [], runs = [], applicationSessions = [], employerBrowserTasks = [], applicationSubmissionTasks = [], applicationReceiptTasks = [], employerBrowserSessions = [], collectionCompleteness = null, now = new Date() }) {
  return {
    schemaVersion: 1,
