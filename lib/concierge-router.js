...
export function conciergeStateGuidance(input = {}) {
  ...
  if (!input.hasResume) return {
    ...
    detail: 'I can build it from a short verified-facts interview or extract an existing PDF, DOCX, or TXT file.',
    actions: [{ label: 'Build my resume', prompt: 'Build my resume' }, { label: 'Upload resume', prompt: 'Upload my resume' }],
  };
