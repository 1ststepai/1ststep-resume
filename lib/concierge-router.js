const JOB_TERMS = /\b(job|jobs|career|careers|resume|résumé|cover letter|application|apply|interview|linkedin|salary|compensation|remote|hybrid|onsite|recruiter|employer|workday|greenhouse|lever|position|role|approval|batch|desk|pipeline|overnight|continue|prepare|skip|exclude|receipt|follow-up|onboarding|readiness|autonomy)\b/i;
