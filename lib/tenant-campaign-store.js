...
const JOB_CARD_KEYS = new Set([
  'id', 'employer', 'title', 'status', 'requisitionId', 'sourceUrl', 'sourceProvider', 'sourceType', 'discoveryRunId', 'applyPathActive',
